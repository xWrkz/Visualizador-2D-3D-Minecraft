...
const specificBuilds = {
    1: [
        { id: 1, title: "Creeper del Bosque", description: "Puedes construir un montón de estructuras espectaculares con formas básicas. Con esta construcción aprenderas a crear un mob clásico, el creeper, con una combinacion de formas cuadradas y rectangulares ¡Preparate para demostrar a los mobs invasores que no les tienes miedo!", modelPath: "models/MC/creeper/", objFile: "Creeper Del Bosque.obj", mtlFile: "Creeper_Del_Bosque.mtl", imagePath: "Portada de Construcciones/MC/1/Creeper.png", descImagePath: "Portada de Construcciones/MC/1/Creeper desc.png", difficulty: 1, time: "20 min" }
    ],
    2: [
        { id: 1, title: "La Estatua de la Rana", description: "¿Quieres construir una estatua con la forma de un batracio colosal? ¿Por qué no construyes esto cerca de tu base? O, aún mejor, añádele una puerta y podrás acceder a su interior y convertirla en tu hogar. Esta rana es naranja, pero puedes usar la imaginacion y construirla con otro color. ¡Sí, eso sera croactástico!", modelPath: "models/MCAL/estatua-rana/", objFile: "La Estatua de la Rana.obj", mtlFile: "La_Estatua_de_la_Rana.mtl", imagePath: "Portada de Construcciones/MCAL/1/Rana.png", descImagePath: "Portada de Construcciones/MCAL/1/Rana desc.png", difficulty: 1, time: "15 min" }
    ],
    4: [
        { id: 1, title: "Estatua del Unicornio", description: "¡Hacer estatuas de tus animales legendarios favoritos es muy divertido! El unicornio mágico es una criatura mitológica que, según se cuenta, trae buena suerte. Construye esta estatua en un sitio bien visible: cerca de tus establos, todo el mundo la admirará cuando traiga sus monturas.", modelPath: "models/MCI/estatua-unicornio/", objFile: "Estatua del Unicornio.obj", mtlFile: "Estatua_del_Unicornio.mtl", imagePath: "Portada de Construcciones/MCI/1/unicornio.png", descImagePath: "Portada de Construcciones/MCI/1/unicornio desc.png", difficulty: 1, time: "10 min" }
    ],
    5: [
        { id: 1, title: "Espejo Mágico", description: "Espejito, espejito ¿quién es el más valiente del re...? ¡Ah, espera! Quería que elogiaras mi valentía, ¡no que me mandaras al Inframundo a demostrarla! ¡Aaah, déjame salir, qué miedo! Construye tu propio espejo mágico, a ver si algún amigo tuyo se acerca esperarando llevarse un piropo.", modelPath: "models/MCM/espejo-magico/", objFile: "Espejo Magico.obj", mtlFile: "Espejo_Magico.mtl", imagePath: "Portada de Construcciones/MCM/1/Espejo Magico.png", descImagePath: "Portada de Construcciones/MCM/1/Espejo Magico desc.png", difficulty: 1, time: "15 min" }
    ]
};
